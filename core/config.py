...
MAX_CAM_ANGLE = (
    60  # maximum degrees of camera when executing LookUp and LookDown actions
)
...
OBJ_COUNT_THRSH = (
    2  # minimum number of an object observation to consider it a really existing object
)
...
OPEN_CLASSIFIER_THRSH = (
    0.5  # Used to classify the "open(object)" and "on(object1, object2)" predicates
)
...
RECEPTACLE_OBJS = [
    ...
    "diningtable",
    "drawer",
    "fridge",  # "dresser", does not exist in floorplan229
    "garbagecan",
    "handtowelholder",
    "laundryhamper",
    "microwave",
    "mug",
    "ottoman",
    "pan",  #  "cup", is too little to generate feasible goals
    "plate",
    "pot",
    "safe",
    "shelf",
    ...
    "sinkbasin",
    "sofa",
    "toaster",  # "sink", is not used since there is sinkbasin
    "toilet",
    "toiletpaperhanger",
    "towelholder",
    "tvstand",
