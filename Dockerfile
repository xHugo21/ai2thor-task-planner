...
# Copy the pre-compiled FF planner binary (already Linux x86-64 in OGAMUS)
RUN mkdir -p /app/planner/metric-ff /app/planner/metric-ff-macos \
    && cp /app/OGAMUS/Plan/PDDL/Planners/FF/ff /app/planner/metric-ff/ff \
    && cp /app/OGAMUS/Plan/PDDL/Planners/FF/ff /app/planner/metric-ff-macos/ff \
    && chmod +x /app/planner/metric-ff/ff /app/planner/metric-ff-macos/ff
